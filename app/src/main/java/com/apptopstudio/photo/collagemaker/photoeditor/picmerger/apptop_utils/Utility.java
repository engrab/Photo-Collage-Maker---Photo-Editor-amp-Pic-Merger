...
public class Utility {
    ...
    public static double getLeftSizeOfMemoryMb() {
        double maxMemory = (double) (Runtime.getRuntime().maxMemory() / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED);
        double totalMemory = (double) (Runtime.getRuntime().totalMemory() / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED);
        Double.isNaN(maxMemory);
        Double.isNaN(totalMemory);
        return (maxMemory - totalMemory) - (Double.valueOf((double) Debug.getNativeHeapAllocatedSize()).doubleValue() / Double.valueOf(1048576.0d).doubleValue());
    }
    ...
    public static void logFreeMemory(Context context) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("free memory own method = ");
        stringBuilder.append(getLeftSizeOfMemory() / 1048576.0d);
        Log.e(str, stringBuilder.toString());
    }
